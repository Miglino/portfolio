      ...
      <div className="about-container">
        ...
        <div className="about-right-top">
          <p className='about-text-right-top'>
            ...
            las aprendi programando en C y mis bases de Programacion con Objetos las aprendi 
            programando en Java.
            Mi favoritismo por el Desarrollo Web comenzo a traves de un curso de JavaScript
            el cual me llevo a que actualmente me encuentre desarrollando con React.js 
            una tecnologia que me encanta y me apasiona.
          </p>
        </div>  
